...
#SpecificGoal #1
Practice.create(id:1, name: 'Estimar el alcance del proyecto', question: '¿Se estima el alcance del proyecto?', examples: 'Ejemplo: Establecer un WBS (Estructura de descomposición de trabajo) para estimar el alcance del proyecto.', added_value: 0, specific_goals_id: 1)
...
Practice.create(id:3, name: 'Definir las fases del ciclo de vida del proyecto', question: '¿Se definen las fases del ciclo de vida del proyecto?', examples: 'Ejemplo de productos de trabajo: Fases del ciclo de vida del proyecto.', added_value: 0, specific_goals_id: 1)
...
#SpecificGoal #2
Practice.create(id:5, name: 'Establecer el presupuesto y el calendario', question: '¿Se establece el presupuesto y el calendario? ', examples: 'Ejemplo de productos de trabajo: Fases del ciclo de vida del proyecto.', added_value: 0, specific_goals_id: 2)
...
Practice.create(id:10, name: 'Planificar la involucración de las partes interesadas', question: '¿Se planifica la involucración de las partes interesadas? ', examples: 'Ejemplo de productos de trabajo: Plan para la involucración de las partes interesadas', added_value: 0, specific_goals_id: 2)
Practice.create(id:11, name: 'Establecer el plan de proyecto', question: '¿Se establece el plan del proyecto? ', examples: 'Ejemplo de productos de trabajo: Plan global del proyecto', added_value: 0, specific_goals_id: 2)

#SpecificGoal #3
Practice.create(id:12, name: 'Revisar los planes que afectan al proyecto', question: '¿Se revisan los planes que afectan al proyecto?', examples: 'Ejemplo de productos de trabajo: Registro de la revisiones de los planes que afectan al proyecto.', added_value: 0, specific_goals_id: 3)
